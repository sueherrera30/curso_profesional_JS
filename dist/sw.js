...
async function precache() {
  ...
  return cache.addAll(['/', './index.html', './assets/index.css', './assets/index.js', './assets/ejercicio.mp4', './assets/MediaPlayer.js', './assets/plugins/autoPause.js', './assets/plugins/autoPlay.js']);
